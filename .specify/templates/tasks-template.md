...
security-relevant behavior. If tests are omitted for a scoped item, add a brief
...
- [ ] T010 Define secure secret/config handling (e.g., Keychain integration)
...
- [ ] T013 [P] [US1] Negative test for invalid input/unsafe path handling
...
- Core tests MUST be written and FAIL before implementation
